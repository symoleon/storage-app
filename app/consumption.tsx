...
import { fetchAllConsumptions, addConsumption } from "@/lib/consumption";
...
export default function ConsumptionPage() {
  const [modalVisible, setModalVisible] = useState(false);
    ...
    useEffect(() => {
      setLoading(true);
      fetchAllConsumptions().then((data) => {
        setOrders(data);
        setLoading(false);
      });
    }, []);
        ...
        <Portal>
          ...
          >
            ...
            <Button mode="contained" onPress={() => {
              addConsumption(selectedProduct, parseInt(quantity)).then((data) => {
